    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-auth-login">Authenticate user and return access and refresh tokens.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-logout">
                                <a href="#endpoints-POSTapi-auth-logout">Logout the authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-refresh">
                                <a href="#endpoints-POSTapi-auth-refresh">Refresh the access token using the refresh token from cookie.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-me">
                                <a href="#endpoints-POSTapi-auth-me">Get the authenticated user's information.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>validates incoming registration data and create a new user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>فیلد value باید یک آدرس ایمیل معتبر باشد. فیلد value نباید بیشتر از 255 کاراکتر باشد. Example: <code>zbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>فیلد value باید حداقل 8 کاراکتر داشته باشد. Example: <code>-0pBNvYgxw</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-auth-login">Authenticate user and return access and refresh tokens.</h2>
...
<li>Issues a JWT access token and a refresh token (in HTTP-only cookie).</li>
</ul>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>فیلد value باید یک آدرس ایمیل معتبر باشد. Example: <code>gbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-logout">Logout the authenticated user.</h2>

<p>
</p>

<ul>
<li>Invalidates the access token.</li>
<li>Deletes the refresh token cookie.</li>
</ul>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-refresh">Refresh the access token using the refresh token from cookie.</h2>
...
<li>Invalidates the old one.</li>
<li>Issues a new access token and new refresh token.</li>
</ul>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-me">Get the authenticated user&#039;s information.</h2>
